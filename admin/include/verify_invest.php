...
$complete = 0;
$date_end = date('Y-m-d H:i:s', strtotime($date. " + $days days"));
    ...
    <td align='center' valign='top' width='100%' style='background-color: #f7f7f7;' class='content-padding'>
      <center>
        <table cellspacing='0' cellpadding='0' width='600' class='w320'>
          ...
          <tr>
            <td class='free-text'>
            Your request to Deposit has been approved check below to see more details of your Deposit.
            </td>
          </tr>
          <tr>
            <td class='button'>
                      ...
                      <tr>
                        <td class='mini-block-padding'>
                          <table cellspacing='0' cellpadding='0' width='100%' style='border-collapse:separate !important;'>
                            <tr>
                              <td class='mini-block'>
                                <span class='header-sm'>Plan and Transaction ID</span><br />
...
$insert_feed = "INSERT INTO live_feed (date,type,description,id_no) VALUES('$date','DEPOSIT-APPROVED','Your Deposit request of $btc $coin has been approved and has been sent to your wallet address ','$id_no')";

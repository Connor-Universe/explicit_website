...
<?php include "../include/top.php";?>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="form1">
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="exampleInputEmail1" name="amount" aria-describedby="emailHelp" placeholder="Enter Amount($USD)" min ="<?php echo"$lower";?>" max ="<?php echo"$upper";?>" required>

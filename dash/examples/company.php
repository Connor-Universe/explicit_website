      ...
      <div class="content">
        <div class="row">
          <div class="col-12">
              ...
              <script type="text/javascript" src="https://files.coinmarketcap.com/static/widget/coinMarquee.js"></script><div id="coinmarketcap-widget-marquee" coins="1,1027,825,1839,2010,52,74" currency="USD" theme="light" transparent="false" show-symbol-logo="true"></div>
        ...
        <div class="row">
        <div class="col-lg-12">
        <script type="text/javascript" src="https://files.coinmarketcap.com/static/widget/coinPriceBlock.js"></script><div id="coinmarketcap-widget-coin-price-block" coins="1,1027,825,2,74,6528,52,1839" currency="USD" theme="light" transparent="false" show-symbol-logo="true"></div>
        </div>
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Total New Investors</h5>
                <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary"></i> <?php echo"$total_users";?></h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info"></i> $<?php echo"$final1";?></h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="tim-icons icon-send text-success"></i> $<?php echo"$final2";?></h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
